...
import { Wand2, Users, Monitor, BookOpen, Shield, Eye, Sword } from "lucide-react"
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground tracking-wider">Magic Duels</h1>
          <p className="text-muted-foreground">A wizarding battle of wits and spells</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <span className="text-lg font-semibold text-foreground">Play vs CPU</span>
          </button>
          ...
          >
            ...
            <span className="text-lg font-semibold text-foreground">2 Player Local</span>
          </button>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-4">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            ...
            <ul className="pl-4 space-y-1 text-center">
              <li>
                <span className="text-aggressive">Aggressive</span> beats <span className="text-sneaky">Sneaky</span>
              </li>
              <li>
                <span className="text-sneaky">Sneaky</span> beats <span className="text-defensive">Defensive</span>
              </li>
              <li>
